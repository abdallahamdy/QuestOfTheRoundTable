...
function showCards(cards) {
  ...
  $("#boardGameDiv").show();
    ...
    for (i = 0; i < cards.length; i++) {
        ...
        $("#cardsDiv").append("<img height='100' width='75' src='" + cards[i].imgLocation + "' onclick='checkCard(cards[" + i + "])'>");
    }
...
function showWhoJoined(message) {
    $("#responseField").append("<tr><td>" + message + " just joined the game!" + "</td></tr>");
}
...
function someoneLeft(msg) {
    $("#responseField").append("<tr><td>" + msg.playername + " just left the game.</td></tr>");
}

function hostLeft(msg) {
    $("#responseField").append("<tr><td> the host: " + msg.oldHost + " just left the game.</td></tr>");
    $("#responseField").append("<tr><td>" + msg.newHost + " is the new game owner.</td></tr>");
}
