...
import com.group42.EventCardBehaviors.*;
public class StoryDeck_T2 extends StoryDeck{
	...
	public StoryDeck_T2() {
		//nCards = nCards;
				...
				//Rigged Order for Tier 2 Scenario
				...
				Plague plagueEvent = new Plague();
				EventCard Plague = new EventCard ("Plague", "Drawer loses 2 shields if possible", "/cards/faceup/Event/E_Plague.jpg", plagueEvent);
